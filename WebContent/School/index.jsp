...
<body>
	...
	<table class="table table-bordered table-hover definewidth m10">
		...
		<tr>
			...
			<td>
				 <a class="option-button" href="${pageContext.request.contextPath }/school/toEdit/${s.id }">编辑</a>
				|<a class="option-button" onclick="del(${s.id});">删除</a>
				|<a class="option-button" href="${pageContext.request.contextPath }/school/toShow/${s.id }">查看</a>
			</td>
		</tr>
		</c:forEach>
	</table>
