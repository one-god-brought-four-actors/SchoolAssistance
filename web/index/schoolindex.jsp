    ...
    <div class="inForBox">
        <div class="inForBox01">
            ...
            <c:forEach items="${school }" var="s">
                <li>
                    <a title="点击查看详情" href="index/toSchoolShow/${s.id }">
                        <span>${s.schName }</span>
			...
			<c:otherwise>
				<a href='index/school' class="first">首页</a>
				<a href='index/school?page= ${page.page - 1 }' class="prev">上一页</a>
			</c:otherwise>
		</c:choose>
                <c:choose>
			...
			<c:otherwise>
				<a href='index/school?page= ${page.page + 1 }' class="next">下一页</a>
				<a href='index/school?page=${page.totalPage }' class="last">尾页</a>
			</c:otherwise>
		</c:choose>
            </div>
        </div>
